class RemoveUuid < ActiveRecord::Migration
  ...
  def self.up
    [:users, :fat_free_crm_accounts, :fat_free_crm_campaigns, :fat_free_crm_leads, :fat_free_crm_contacts, :fat_free_crm_opportunities, :fat_free_crm_tasks].each do |table|
