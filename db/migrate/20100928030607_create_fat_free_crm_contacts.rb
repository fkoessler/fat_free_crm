class CreateFatFreeCRMContacts < ActiveRecord::Migration
  def self.up
    ...
    add_index :fat_free_crm_contacts, [:user_id, :last_name, :deleted_at], unique: true, name: 'id_last_name_deleted'
