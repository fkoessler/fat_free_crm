{
  ...
  groups.each do |group|
    field_group = FatFreeCRM::FieldGroup.create group[:params].merge(klass_name: klass_name, position: group_position)
    group[:fields].each_with_index do |params, field_position|
      FatFreeCRM::Field.create params.merge(field_group: field_group, position: field_position)
    end
  end
end
