...
class FatFreeCRM::CustomField < FatFreeCRM::Field
  ...
  def available_as
    FatFreeCRM::Field.field_types.reject do |new_type, _params|
  ...
  #------------------------------------------------------------------------------
  def column_options
    FatFreeCRM::Field.field_types[as][:column_options] || {}
  end
  ...
  def add_ransack_translation
    I18n.backend.store_translations(FatFreeCRM::Setting.locale.to_sym,
